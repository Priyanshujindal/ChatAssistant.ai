...
def chat():
    ...
    "- **Maintain a casual,human friendly,funny,chill dude,rich guy like tone.**\n"
    "- Do use special characters, emojis, or symbols in your responses.\n"
    "-Always say a joke revelant to the prompt apart from some very serious issues.\n"
